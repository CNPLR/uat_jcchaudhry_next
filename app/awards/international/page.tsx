...
const page = async () => {
  return (
     <div>
            <div>
                <Banner title="International Awards" alttag="Dr. JC Chaudhry International Awards" path="/allbanners/Dr-J-C-Chaudhrys-international-awards-and-achievements.webp" />
            </div>
            <div className='px-10'>
                <ImgHeadingContent
                ...
                <CommonFlipCard
                    ...
                    alt="Dr. JC Chaudhry Global Recognition"
                    alt1="Dr. JC Chaudhry Global Recognition"
                ...
                <CommonFlipCard
                    ...
                    alt="Global Gandhi Award"
                    alt1="Global Gandhi Award"
                    title="Global Gandhi Award"
                />
                <CommonFlipCard
                    year="2019"
                    ...
                    alt="Dr. JC Chaudhry Keynote Speaker"
                    alt1="Dr. JC Chaudhry Keynote Speaker"
                ...
                <CommonFlipCard
                    ...
                    alt="Dr. JC Chaudhry Excellence Award"
                    alt1="Dr. JC Chaudhry Excellence Award"
                ...
                <CommonFlipCard
                    ...
                    alt="Global Award of the Year"
                    alt1="Global Award of the Year"
                    title="Global Award"
                />
                <CommonFlipCard
                    year="2018"
                ...
                <CommonFlipCard
                    ...
                    alt="Dr. JC Chaudhry Lifetime Achievement"
                    alt1="Dr. JC Chaudhry Lifetime Achievement"
                ...
                <CommonFlipCard
                    ...
                    alt="Asia One Person of the Year Award"
                    alt1="Asia One Person of the Year Award"
                    title="Asia One POY Award"
                />
                <CommonFlipCard
                    year="2016"
                    ...
                    alt="Asian Lifetime Achievement Award"
                    alt1="Asian Lifetime Achievement Award"
                    title="Asian Lifetime Achievement"
                />
            </div>
        </div>
  )
