...
export function CalculatorNumber({ num, handleClick, activeTab, setActiveTab }: CalculatorNumberProps) {
    return (
        <div>
            <button onClick={e => { setActiveTab(num); handleClick?.() }} className={`font_family text-5xl text-white border border-white w-16 h-16 shadow-md rounded-full mb-5 md:mb-0 flex justify-center items-center mx-3 cursor-pointer bg-[#CC66CC] ${activeTab === num && " bg-purple-600"} `}>
