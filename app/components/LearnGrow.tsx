  ...
  return (
    <div className="homeservices py-10">
      ...
      <div className="flex flex-wrap px-10 justify-center">
        ...
        <CommonLearnGrow title="Numerology Predictions" alt="Dr. JC Chaudhry Numerology Predictions" link="/video/2024-numerology-predictions" path="/images_folder/learn_predication_2024.webp" subHeading="2026 Predictions" />
      </div>
    </div>
  );
}
