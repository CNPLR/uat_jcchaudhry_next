  ...
  return (
     <div>
            <Link href={token ? '/dashboard' : '/numerology/signup'}>
                <Banner title="Career Numerology Consulation" alttag="Dr. JC Chaudhry career Numerology " priority path="/allbanners/Career-numerology-reading-services-by-Dr-J-C-Chaudhry.webp" />
            </Link>
