...
<main>
  <header>
     <span className="skeleton-box" style={{width:"100%",height:"40vh"}}> </span>
  </header>
  <section className="card-seciton">
     <ul className="o-vertical-spacing o-vertical-spacing--l">

    <li className="blog-post o-media">
      <div className="o-media__figure">
        <span className="skeleton-box" style={{width:"30vw", height:"30vh"}}></span>
      </div>
