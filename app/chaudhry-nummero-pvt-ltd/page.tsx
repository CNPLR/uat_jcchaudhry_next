...
const pridiction:any = getVideos('getvideobyid/id/66d04093b339edc1a648849d');
    ...
    <div>
            ...
            <div className='lg:flex justify-center items-start mt-7'>
                <div className='flex items-center mt-7 border bg-slate-100 px-10 pt-10 rounded-md justify-center flex-wrap'>
                    ...
                    {pridiction?.data ?
                        <CommonVideos
                            path={`https://newcnpl.s3.ap-south-1.amazonaws.com/public/jccms/videosthumbnail/${pridiction.data.category}/${pridiction.data.thumbnail}`}
                            url={pridiction.data.videoUrl}
                            para={pridiction.data.title}
                        />
                        : ''
                    }
                </div>
